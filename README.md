# Hawthorne Ridge HOA — Plain-English Guide
...
- Every homeowner is automatically a member. You can't opt out, and the rules are tied to your deed.
- Two groups make decisions: the **Board** (runs the community) and the **Architectural Standards Committee** (approves changes to your home's exterior).
- Almost any visible change to the outside of your house or yard needs written approval **before** you start.
- Break a rule and you get a warning first, then fines, then potentially a lien on your home.

---

## Getting Approval for Changes (the #1 thing to know)
...
5. Once approved, you must **start within 6 months** and **finish within 12 months**, or the approval expires.

**Important:** HOA approval is separate from any township building permit you might need. You still have to get those yourself.
...
- Clean up after them. No dog houses or dog runs allowed.
...
- Fees: **$100** to register a new lease, **$50** to renew with the same tenant.
- Skip the paperwork and you face a $100 penalty, then $350 and rising if you don't fix it.
...
- **Never** connect roof drains or sump pumps to the public sewer.
...
The HOA follows a step-by-step process before it can fine you:

1. **Warning letter** describing the violation and giving you time to fix it.
2. **30 days** to correct it (or make real progress).
3. If still not fixed, a **certified letter** gives you **10 more days**.
4. If you still don't act, the HOA can fix it themselves and **bill you** (plus a 20% admin fee), and/or fine you.
...
## Can You Leave the HOA?

Short answer: **No, not on your own.** Membership is tied to your deed and there's no built-in way for a single homeowner to remove their property from the association. Only full community dissolution (a major group vote) or developer-level rights could change that. If you believe your lot was never properly included, that's a legal argument requiring an attorney and the original recorded plat maps — not something the rules let you do directly.
